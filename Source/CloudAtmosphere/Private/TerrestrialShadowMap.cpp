...
namespace TerrestrialShadow
{
	void AddBakePass_RenderThread(FRDGBuilder& GraphBuilder, const FTerrestrialShadowParams& Params)
	{
		...
		P->ActivityDepth = Params.ActivityDepth;
		P->ActivityLift = Params.ActivityLift;
		P->ActivityRamp = Params.ActivityRamp;
		P->SystemDepth = Params.SystemDepth;
		P->SystemLift = Params.SystemLift;
		P->SystemRamp = Params.SystemRamp;
		P->JetDepth = Params.JetDepth;
		P->JetLift = Params.JetLift;
		P->TropicalDepth = Params.TropicalDepth;
		P->TropicalLift = Params.TropicalLift;
		P->TropicalRamp = Params.TropicalRamp;
		P->RampSpeed = Params.RampSpeed;
